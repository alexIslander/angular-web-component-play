import { booleanAttribute, Component, input, linkedSignal, output, Input } from '@angular/core';

@Component({
    selector: 'app-like-button',
    template: `
        <button (click)="toggleLike()" [style.width]="size" [style.height]="size">
...
export class LikeButtonComponent {
    ...
    @Input() size: string = '40px'; // default
